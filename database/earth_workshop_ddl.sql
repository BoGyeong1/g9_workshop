...
(
  ...
  NAME        VARCHAR(255) NOT NULL COMMENT '주소별명',
...
(
  ...
  NAME      VARCHAR(255) NOT NULL COMMENT '관리자명',
...
(
  ...
  EXPOSURE    VARCHAR(255) NOT NULL COMMENT '노출여부',
  ORDER       INTEGER      NOT NULL COMMENT '노출 순서',
...
(
  ...
  CONDITION           VARCHAR(255) NOT NULL COMMENT '상태',
...
(
  ...
  ADDRESS_UID           VARCHAR(255) NOT NULL COMMENT '주소 UID',
  DELIVERY_LOCATION_UID VARCHAR(255) NOT NULL COMMENT '배송장소  UID',
  CONDITION_UID         VARCHAR(255) NOT NULL COMMENT '상태 UID',
...
(
  ...
  PAYMENT_METHOD     VARCHAR(255) NULL     COMMENT '결제수단명',
...
(
  ...
  DESC          VARCHAR(255) NOT NULL COMMENT '상품 간략 설명',
  PRICE         INTEGER      NOT NULL COMMENT '가격',
...
ALTER TABLE EVENT_BANNERS
  ADD CONSTRAINT FK_EVENTS_TO_EVENT_BANNERS
...
ALTER TABLE EVENTS
  ADD CONSTRAINT FK_ADMINS_TO_EVENTS
    FOREIGN KEY (ADMIN_UID)
    REFERENCES ADMINS (ADMIN_UID);
