...
<body>
    ...
    <%-- [SOO] Main Banner --%>
    <div id="main-img-box">
        <img src="/resources/img/bg/main_bg.png" alt="banner" class="w-100" id="main-img">
        <div id="main-text">
            <div class="m-3">
            ...
            <div id="main-img-box" class="m-3">
                <img id="main-img" src="/resources/img/logo/G9_Logo_White.png" alt="logo" class="w-50">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div id="section-head" class="mt-5 mb-3 d-flex justify-content-between">
            <div id="section-title-box" class="d-flex align-items-center">
                ...
                <img id="section-img" src="/resources/img/logo/G9_Logo.png" alt="" style="height: 30px;">
            </div>
    ...
    <div id="main-img-box">
        <img src="/resources/img/bg/banner1.png" alt="banner" class="w-100 my-5" id="main-img">
        <div id="main-text">
            <div class="fw-bold fs-5">About Earth Workshop</div>
            <div class="mt-1">
                <img src="/resources/img/logo/G9_Logo_White.png" alt="" class="w-25">
            </div>
            <span class="py-4">
