        ...
        <div>
            <table style="text-align: left;">
                ...
                <div style="font-size: 0.8rem;" class="text-end">작성일
                    <span>
                        <fmt:formatDate value="${boardList.CREATE_DATE}" pattern="yyyy-MM-dd" />
                    </span>
                </div>
                <!-- 수정일 -->
                <div style="font-size: 0.8rem;" class="text-end">수정일 
                    <span>
                        <fmt:formatDate value="${boardList.MODIFIED_DATE}" pattern="yyyy-MM-dd" />
                    </span>
                </div>
            </table>
        <!-- 게시글 본문  -->
            <div style="width: 900px; height: 500px; border: 1px solid transparent; display: flex; justify-content: center; align-items: flex-start;">
