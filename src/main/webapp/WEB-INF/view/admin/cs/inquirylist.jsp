    ...
    <div class="d-flex">
        ...
        <div class="w-100 m-5">
            <div id="search-form">
                ...
                <div class="fs-4">답변이 필요한 1:1 문의 목록</div>
                ...
                <tr>
                <td class="text-center">${resultData.PRIVATE_INQUIRY_UID}</td>
                <td class="text-center">${resultData.USER_UID}</td>
                <td class="text-center">${resultData.CATEGORY_NAME}</td>
                <td class="text-center"><a href="/admin/inquiry/inquirys/${resultData.PRIVATE_INQUIRY_UID}">${resultData.TITLE}</a></td>
                <td class="text-center">${resultData.CREATE_DATE}</td>
                </tr>
                </c:forEach>
                </tbody>
                </table>
