    ...
    <div class="d-flex">
        ...
        <div class="container w-50 mt-5">
            <form action="/admin/board/${form_action}" method="post">
                ...
                <table class="table">
                    ...
                    <tbody class="table-group-divider">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="TOP_FIXED" id="TOP_FIXED" name="TOP_FIXED" ${resultMap.TOP_FIXED == 'YES' ? 'checked' : ''}>
                        ...
                        <tr>
                            <th scope="row">제목</th>
                            <td colspan="3">
                                <input type="text" name="TITLE" id="TITLE" class="form-control w-100" required value="${resultMap.TITLE}"> 
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <input type="hidden" id="CONTENT" name="CONTENT" value="${resultMap.CONTENT}">
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <input type="hidden" name="POST_UID" value="${resultMap.POST_UID}">
            </form>
        </div>
    </div>
